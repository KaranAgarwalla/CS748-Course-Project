...
if __name__ == '__main__':
    ...
    if TRAIN:
        ...
        for time_step in range(100000, 51000000, 100000):
            ...
            reward = eval_model(FRAME_SKIP, args.path, time_step, META_PATH, CHECKPOINT)
            with open(os.path.join(args.path, 'evaluation.dat'), 'a') as f:
                print(time_step, reward, file = f)